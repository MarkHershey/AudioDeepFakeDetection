...
def load_directory_split_train_test(
    ...
    Args:
        ...
        feature_fn (Callable): This is assumed to be mfcc or mel_spectrogram function.
...
if __name__ == "__main__":
    real_dataset_train, real_dataset_test = load_directory_split_train_test(
        path="/media/jamestiotio/Data/LJ_Speech",
        feature_fn=mel_spectrogram,
        feature_kwargs={},
        test_size=0.2,
    ...
    fake_dataset_train, fake_dataset_test = load_directory_split_train_test(
        path="/media/jamestiotio/Data/ljspeech_melgan_large",
        feature_fn=mel_spectrogram,
        feature_kwargs={},
        test_size=0.2,
        use_double_delta=True,
